        ...
        <div key={product.id}>
          ...
          <div className="mt-4 px-5 pb-5">
            ...
            <div className="mt-2 mb-5 flex items-center justify-between">
              ...
              {!isNaN(product.rating) && [...Array(Math.round(product.rating))].map((_, index) => (
            ...
            <button onClick={()=> send(product)} className="flex items-center justify-center rounded-md bg-[#D88552] px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-blue-300">
              ...
              <button  className="flex items-center justify-center rounded-md bg-[#D88552] px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-blue-300 opacity-50 cursor-not-allowed">
